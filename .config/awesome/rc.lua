...
mymainmenu = awful.menu({items = {
                             ...
                             {"terminal", terminal},
                             {"chrome (personal)", "/home/e/bin/run-chrome personal"},
                             {"chrome (work)", "/home/e/bin/run-chrome work"},
                          }
                        })
...
globalkeys = awful.util.table.join(
    ...
    awful.key({"Mod1", "Control", "Shift"}, "k", function () awful.client.swap.byidx( -1) end),
    awful.key({"Mod1", "Control", "Mod4"}, "j", function () awful.screen.focus_relative( 1) end),
    awful.key({"Mod1", "Control", "Mod4"}, "k", function () awful.screen.focus_relative(-1) end),
    awful.key({"Mod1", "Control"}, "u", awful.client.urgent.jumpto),
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ "Mod4", "Shift"}, "r", function (c) c:redraw() end),
...
client.add_signal("manage", function (c, startup)
    -- Add a titlebar
    -- awful.titlebar.add(c, { modkey = "Mod4" })
